"""Local Bluetooth adapter MAC detection and advertisement classification."""

import subprocess
import sys
from typing import Optional

from bridge.constants import NINTENDO_BLUETOOTH_MANUFACTURER_ID, NINTENDO_VENDOR_ID, PRO_CONTROLLER2_PID
from bridge.logging_config import log, log_debug
from bridge.utils import decodeu, subprocess_hide_window
